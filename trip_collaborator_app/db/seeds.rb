...
item1 = Item.create({name: "bacon", quantity: 2, user_id: 1})
item2 = Item.create({name: "sleeping bag", quantity: 1, user_id: 1})
item3 = Item.create({name: "camping stove", quantity: 1, user_id: 1})
item4 = Item.create({name: "tent", quantity: 1, user_id: 1})
item5 = Item.create({name: "swimsuit", quantity: 1, user_id: 2})
item6 = Item.create({name: "sunscreen", quantity: 1, user_id: 2})
item7 = Item.create({name: "cooler", quantity: 1, user_id: 2})
item8 = Item.create({name: "shovel", quantity: 1, user_id: 2})
item9 = Item.create({name: "skis", quantity: 2, user_id: 3})
item10 = Item.create({name: "ski pole", quantity: 1, user_id: 3})
item11 = Item.create({name: "ski pants", quantity: 2, user_id: 3})
item12 = Item.create({name: "goggles", quantity: 1, user_id: 3})
item13 = Item.create({name: "glove", quantity: 1, user_id: 4})
item14 = Item.create({name: "bat", quantity: 1, user_id: 4})
item15 = Item.create({name: "uniform", quantity: 2, user_id: 4})
item16 = Item.create({name: "cleats", quantity: 1, user_id: 4})
